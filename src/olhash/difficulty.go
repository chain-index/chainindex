...
func GetDifficultyPreExp(currentTimestamp, lastBlockTimestamp uint64, lastBlockDiff, minimumDiff *big.Int, nNewBlocks int64, newestHeaderInBlock *ci_pb.BlockchainHeader) *big.Int {
	result := new(big.Int)
